...
//Ouvertue de session pour conserver les informations de l'utilisateur de page en page
...
if (isset($_GET["controller"])) {
    ...
    $controller_to_run = "welcome.ctrl";
}
...
if (file_exists($controller_file_name)){
    ...
    $controllerClassName = explode(".", $controller_to_run)[0];
